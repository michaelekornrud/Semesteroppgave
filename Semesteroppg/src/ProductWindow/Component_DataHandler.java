...
public class Component_DataHandler {
    ...
    public void changeDataFromTableviewToCsvAndSave(Map<String, List<Product>> data) throws Exception{   //Metode som sletter gammel data fra csv-fil og lagrer den nye dataen.
        Writer writer = null;
    ...
    public void removeObjectFromChoiceBoxAndCsvFile(String lineContent) throws Exception{  //Metode for å slette objekter fra csv-filen
